...
public class ServiceFloating extends Service implements Runnable {
	...
	public void onCreate() {
		...
		// LogUtil.v("wordbubble: " + wordBubbleParams.x + ", " +
		// wordBubbleParams.y);
			...
			chatHead.setOnTouchListener(new View.OnTouchListener() {
				...
				public boolean onTouch(View v, MotionEvent event) {
					...
					case MotionEvent.ACTION_DOWN:
						LogUtil.v("onTouch_ACTION_DOWN invoked!! movecheck: "
								+ moveCheck);
						initialX = paramsF.x;
						initialY = paramsF.y;
					...
					case MotionEvent.ACTION_UP:
						...
						if (moveCheck < 3) {
							...
							Intent intent = new Intent(getApplicationContext(),
									BalloonHeadButtonActivity.class);
	...
	public void onDestroy() {
		...
		if (wordBubble != null)
			windowManager.removeView(wordBubble);
		if (quit != null)
			windowManager.removeView(quit);
